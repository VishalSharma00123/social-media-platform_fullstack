...
"[project]/social-frontend/src/app/(auth)/login/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$social$2d$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/users/login", formData);
...
_s(LoginPage, "u7MqyUrGBD7E9m5/xm/Cy64R9I0=", false, function() {
    return [
...
//# sourceMappingURL=social-frontend_src_ce5fbcd1._.js.map